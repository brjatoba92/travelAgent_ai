...
def loadData():
    ...
    web_paths=("https://www.dicasdeviagem.com/alemanha/"),
...
def supervisorAgent(query, llm, webContext, relevant_documents):
    ...
    Uilize o contexto de eventos de preços de passagens, o input do usuario e também os documentos relevantes para elaborar o roteiro.
    Contexto: {webContext}
...
def getResponse(query, llm):
    webContext = reserchAgent(query, llm)
